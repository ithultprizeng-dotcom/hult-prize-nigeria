  ...
  return (
    <section className="h-40 flex items-end">
      <div className="flex items-end gap-3">
        <div className="h-30 w-30 bg-pink rounded-tr-[200%]"></div>
        <div className="h-25 w-25 bg-pink rotate-45 translate-y-[50%]"></div>
      </div>
  ...
  return (
    <section className="h-50 flex items-end bg-pink overflow-hidden">
      ...
      <div className="size-40 rotate-45 translate-y-[50%] translate-x-[-30px] bg-white ml-auto flex justify-center items-center">
        <div className="rounded-full size-15 bg-pink -translate-6"></div>
      </div>
    </section>
  );
};
