...
export default function Hero() {
  return (
    <section className="flex flex-col lg:flex-row items-center gap-14 justify-start">
      <div className="flex flex-col gap-2">
        ...
        <p className="mt-4 font-body font-normal text-body text-[#707070] max-w-prose lg:max-w-[45ch]">
        ...
        <p className="font-body font-normal text-body text-[#707070] max-w-prose lg:max-w-[45ch]">
      ...
      <div className="relative">
        <div
          className="w-[min(300px,95vw)] clip:w-[700px] h-140 bg-pink rounded-lg shrink-0 overflow-clip relative image-clip bg-cover bg-center lg:bg-fixed border"
          style={{
